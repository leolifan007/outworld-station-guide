...
Outworld Station supports up to 4 players in online PVE co-op. You can share exploration, combat, and construction tasks with your friends. But like most co-op games, there are some things that work differently than single-player — and a few ways to mess it up.

## Quick Answer

**To play co-op:**
1. **Host creates a game** from the main menu or pause menu
2. **Friends join** via Steam overlay (right-click host → Join Game) or through in-game lobby
...
1. From main menu: Select **"Host Game"** → Choose your save → Set room name (optional)
2. From in-game: Press **Escape** → **"Open to Players"** → Set room name
...
**Check:**
- Both on same Steam region? (Settings → Downloads → Download Region)
...
- Host's connection matters most — consider switching to player with best internet
...
Don't just optimize — enjoy the game together.
...
- [Station Layout Guide](/guides/station-layout-guide/) — Build stations that work for multiple players
- [Beginner Mistakes](/guides/beginner-mistakes/) — Avoid these in co-op too
- [Freighter and Mining Guide](/guides/freighter-mining-guide/) — Coordinate remote operations
- [Drone Defense Guide](/guides/drone-defense-guide/) — Share defense duties effectively
