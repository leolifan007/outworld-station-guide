...
<div class="callout callout-tip">
  <strong>Pro tip:</strong> Stack identical contracts on the same route. If three stations are all requesting Steel Beams from the same source, run one ship with three contract slots instead of three ships. Credits per trip triple with zero extra flight time.
</div>
...
<div class="callout callout-verdict">
  <strong>My verdict:</strong> Passive income works. But it replaces your active income, it supplements it. A good passive setup earns roughly 30-40% of what you would make manually grinding the same contracts. The difference is you can go build a ship, redesign a factory, or log off while it runs. Over a play session that extra 1,500-3,000 credits adds up to real buying power.
</div>
...
- Build a bigger ship for Cross-System contracts (read the [ship-building guide]({{< ref "/guides/ship-building" >}}) for a cheap jump-drive freighter design).
- Haul mined resources from your [freighter mining operation]({{< ref "/guides/freighter-mining-guide" >}}) directly to the contract board instead of selling raw ore at floor price.
