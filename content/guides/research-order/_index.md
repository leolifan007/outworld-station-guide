...
<div class="callout callout-verdict">
  <h4>The answer</h4>
  <p>Power infrastructure first, then oxygen, then production expansion. Everything else is situational.</p>
</div>
...
<div class="pro-tip">
  <p><strong>Build order:</strong> Oxygen Generator → Gas Pipe → Vent. One generator supports a small station indefinitely. Don't overbuild. For the full gas loop including scrubbers and pressure management, see our <a href="/guides/life-support-oxygen-guide/">Life Support and Oxygen Guide</a>.</p>
</div>
...
<div class="pro-tip">
  <p><strong>Fusion checklist:</strong> Nitrox production → Storage → Reactor. Skip any step and you're building a very expensive paperweight. Our <a href="/guides/nitrox-gas-processing-guide/">Nitrox Gas Processing Guide</a> walks through the full fuel chain from raw gas to reactor-ready Nitrox.</p>
</div>
...
<div class="col">
  <h4>Why they wait</h4>
  <ul>
    <li>Storage: Diminishing returns early</li>
    <li>Materials: Production bottleneck not material bottleneck</li>
    <li>Decorations: Zero survival value</li>
    <li>Gases: Each gas type needs its own infrastructure</li>
  </ul>
</div>
...
1. **Solar Efficiency** (immediate power boost)
2. **Small Battery** (night survival)
3. **Smelter + Alloys** (material production)
4. **Oxygen Generator** (before hour 2)
5. **Medium Storage** (production buffer)
6. **Advanced Drilling** (ore throughput)
7. **Small Reactor + Cooling** (power independence)
8. **Wormhole Tech** (expansion options)
9. **Drone Ports** (automated logistics)
10. **Fusion Reactor** (endgame power)
11. **Ark Ship** (victory)
